...
EPSILON_DECAY = 1e-5    # decay for epsilon 
...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed):
        ...
        # Copy model parameters of Actor networks (from target to local ones)
    ...
    def act(self, states, add_noise=True):
        ...
        if add_noise:
            ...
            for i in range(self.num_agents):
                actions[i] += self.noise.sample() * np.maximum(self.epsilon, 0.2)
